                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form class="new-added-form" action="{{route('coupon.store')}}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" placeholder="Enter coupon title" class="form-control" name="title" value="{{old('title')}}">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-md-3 form-label">Coupon code *:</label>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="Enter coupon code" class="form-control" name="code" value="{{old('code')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <select name="type" class="form-control form-select select2" data-bs-placeholder="Select discount type">
                                                <option value="fixed" {{old('type')=='fixed' ? 'selected': ''}}>Amount</option>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" placeholder="Enter value" class="form-control"  name="value" value="{{old('value')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" placeholder="yyyy-mm-dd" autocomplete="off" name="start_date" class="form-control air-datepicker"
                                                   data-position='bottom right' value="{{old('start_date')}}">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" placeholder="yyyy-mm-dd" autocomplete="off" name="expire_date" class="form-control air-datepicker"
                                                   data-position='bottom right' value="{{old('expire_date')}}">
                                            <i class="far fa-calendar-alt"></i>
                                        </div>
                                    </div>
                                    <!--Row-->
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <button type="submit" class="btn btn-primary"><i class="fe fe-plus-circle"></i> Add Coupon</button>
                                        </div>
                                    </div>
                                    <!--End Row-->
                                </div>
