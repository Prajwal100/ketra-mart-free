                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Update Shipping</div>
                            </div>
                            <form class="new-added-form" action="{{route('shipping.update',$shipping->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="card-body">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" required class="form-control" placeholder="Shipping Address" name="shipping_address" value="{{$shipping->shipping_address}}">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-md-3 form-label">Delivery Time (approx) :</label>
                                        <div class="col-md-9">
                                            <input type="text" required class="form-control" placeholder="Deliver Time" name="delivery_time" value="{{$shipping->delivery_time}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mb-4">
                                            <input type="number" required step="any" class="form-control" placeholder="Deliver Charge" name="delivery_charge" value="{{$shipping->delivery_charge}}">
                                        </div>
                                    </div>
                                    <!--End Row-->
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <button type="submit" class="btn btn-primary"><i class="fe fe-plus-circle"></i> Update Shipping</button>
                                        </div>
                                    </div>
                                    <!--End Row-->
                                </div>
