                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form class="new-added-form" action="{{route('staff.update',$staff->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                ...
                                <div class="card-body">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" placeholder="Enter name" class="form-control" name="name" value="{{$staff->admin->name}}">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-md-3 form-label">Email *:</label>
                                        <div class="col-md-9">
                                            <input type="email" placeholder="Enter email" class="form-control" name="email" value="{{$staff->admin->email}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="status" class="form-control select2 form-select" data-placeholder="Choose one">
                                                <option value="active" {{$staff->admin->status=='active' ? 'selected' : ''}}>Active</option>
                                                <option value="inactive" {{$staff->admin->status=='inactive' ? 'selected' : ''}}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!--End Row-->
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <button type="submit" class="btn btn-primary"><i class="fe fe-plus-circle"></i> Update Staff</button>
                                        </div>
                                    </div>
                                    <!--End Row-->
                                </div>
