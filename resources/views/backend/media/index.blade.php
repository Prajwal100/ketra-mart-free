                        ...
                        <div class="modal-header">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h4 class="modal-title pb-2" >File Manager <small style="font-size: 10px">[Recommend image size 288*345]</small></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
...
@push('scripts')
    <script type="text/javascript">
        $('a.thumbnail').on('click', function(e) {
            ...
            $('.custom-image-'+target_id).html("<a href='javascript:;' class=\"position-absolute button-clear\" data-target-id='"+target_id+"' style='left: 10px; top:10px;' id='button-clear'><i class='fas fa-trash-alt position-absolute text-danger'></i></a>\n");
        ...
        $(document).on('click','.pagination a', function(e) {
            ...
            $('#filemanager').append('<div style="position: fixed;z-index: 9999; left: 50%;top: 37% ;width: 100%">\n' +
                '                    <img width="200" src="{{Helper::loader()}}">\n' +
                '                </div>');
            $('#filemanager').load(target_url);
        });
        // upload file
        ...
        $('#button-folder').on('shown.bs.popover', function() {
            $('#button-create').on('click', function() {
                ...
                $.ajax({
                    url:"{{url('/admin/filemanager/folder')}}",
                    type: 'post',
                    dataType: 'json',
        ...
        $('#permanent-button-delete').on('click', function(e) {
